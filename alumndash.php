    ...
    <main class="h-screen flex">
        <div class="w-custom-300 h-custom-660 bg-zinc-700">
            ...
            <div class="p-5 flex flex-col">
                <p class="flex justify-center text-gray-300 pb-4 text-sm">MENU ALUMNOS</p>
                <div class="flex flex-col items-start">
                    <button class="text-gray-300" onclick="calificacion()">Qualifications</button>
