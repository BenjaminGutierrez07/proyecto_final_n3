        ...
        <div class="w-custom-300 h-custom-660 bg-zinc-700">
            ...
            <div class="p-5 flex flex-col">
                ...
                <div class="flex flex-col items-start gap-3">
                    <button class="text-gray-300" onclick="permisos()">
                    ...
                    <button class="text-gray-300" onclick="maestros()">
                    ...
                    <button class="text-gray-300" onclick="alumnos()">
                    ...
                    <button class="text-gray-300" onclick="clases()">
        ...
        <div class="flex flex-col">
            ...
            <div>
                ...
                <div class="w-custom-1150 h-10 p-1.5 bg-slate-50 border-b-2 flex justify-between">
                    ...
                    <button class="w-custom-100 h-custom-30 bg-sky-600 text-white rounded-md">Add Class</button>
                </div>
                <div class="w-full h-custom-450 p-4 bg-slate-50 rounded-b-lg">
                    ...
                    <div class="w-custom-1100 flex flex-col p-2">
                        <div class="w-custom-1100 h-custom-40 flex bg-white">
                            ...
                            <div class="w-custom-300 border-2 border-slate-900 flex items-center p-2 font-bold">Maestro</div>
                            <div class="w-custom-300 border-2 border-slate-900 flex items-center p-2 font-bold">Alumnos Inscritos</div>
                        ...
                        while ($fila = mysqli_fetch_assoc($resultado)) {
                            ...
                            echo "<div class='w-custom-220 border-2 border-slate-900 flex items-center p-2'>" . 0 . "</div>";
