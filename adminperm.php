    ...
    <main class="h-screen flex">
        ...
        <div class="flex flex-col">
            ...
            <div>
                ...
                <div class="w-custom-1150 h-10 p-1.5 bg-slate-50 border-b-2">
                ...
                <div class="w-full h-custom-450 p-4 bg-slate-50 rounded-b-lg">
                    ...
                    <div class="w-custom-1100 flex flex-col p-2">
                        <div class="w-custom-1100 h-custom-40 flex bg-white">
                            ...
                            <div class="w-custom-300 border-2 border-slate-900 flex items-center p-2 font-bold">Email/Usuario</div>
                            <div class="w-custom-300 border-2 border-slate-900 flex items-center p-2 font-bold">Permiso</div>
                            <div class="w-custom-300 border-2 border-slate-900 flex items-center p-2 font-bold">Estado</div>
